...
from wordle_solver.utils import calculate_wordle_hint
...
def test_success(guess: str, secret: str, expected_output: tuple[int, ...]) -> None:
    assert calculate_wordle_hint(guess, secret) == expected_output
...
def test_failure(guess: str, secret: str, expected_output: tuple[int, ...]) -> None:
    assert calculate_wordle_hint(guess, secret) != expected_output
